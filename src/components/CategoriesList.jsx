...
const CategoriesList = (props) => {
  const fadeIn = useSpring({ 
    from: { display: 'flex',flexDirection: 'row',flexWrap: 'wrap',justifyContent:'center',opacity: 0 },
    to: { display: 'flex',flexDirection: 'row',flexWrap: 'wrap',justifyContent:'center',opacity: 1 }, 
    delay: 150, 
  })
  ...
  return (
    <animated.div style={fadeIn} className='body__home'>
            ...
            <MDBCard key={element.name} className='MDBCard-Home hover-zoom' onClick={()=>props.setDisplay(index)} style={{textAlign: 'center', margin: "20px",cursor: 'pointer'}}>
